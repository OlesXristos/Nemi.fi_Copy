      ...
      <Dialog open={isOpen} onOpenChange={setIsOpen}>
        <DialogContent className="h-full">
          ...
          <div className="flex items-center justify-center">
            <div className="flex flex-col items-center border justify-center py-5 px-5 sm:py-10 sm:px-10 rounded-xl dark:bg-black  overflow-auto shadow-xl">
              ...
              <div className=" space-y-5 mb-7">
                <div className=" sm:flex border border-amber-400/50 dark:bg-black rounded-xl p-3 sm:p-6 gap-2 text-amber-700 dark:text-amber-300 bg-yellow-100/25 group  transition-all duration-300  hover:shadow-xl">
                  ...
                  <div className="">
                    ...
                    <p className="text-sm text-amber-600 dark:text-amber-100">
                      Test environment with no real-world token value. Expect bugs and data resets.
                    </p>
                  </div>
                </div>
                <div className="sm:flex border border-blue-500/50 rounded-xl p-3 dark:bg-black sm:p-6 gap-2 text-blue-500 transition-all duration-300 bg-blue-200/25 hover:shadow-xl group">
                  <div className="  flex justify-center items-center sm:block">
